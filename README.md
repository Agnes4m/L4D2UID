...
<h1 align = "center">L4D2UID 0.2.0</h1>
<h4 align = "center">🚧支持QQ群/频道、OneBot、微信、KOOK、Tg、飞书、DoDo、Discord的 L4D2 插件🚧</h4>
<div align = "center">
...
>
> 支持 NoneBot2 & HoshinoBot & ZeroBot & YunzaiBot & Koishi 的 L4D2 插件
>
> 🚧 暂时未完成，等待施工中...🚧
...
1. 进入 plugins 目录，`git clone --depth 1 https://github.com/Agnes4m/L4D2UID.git`
2. 发送`core重启`应用插件
